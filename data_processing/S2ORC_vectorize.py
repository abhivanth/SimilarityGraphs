...
np.savetxt("data_processing/embeddings/s2orc_embeddings_bert.csv", final_embeddings_bert, delimiter=",")
print("Bert Done")

# colBert Embeddings
final_embeddings_colbert = Bert_vectorizer.vectorize_data(df_S2ORC, 'text', 'id')
print(final_embeddings_colbert.shape)
np.savetxt("data_processing/embeddings/s2orc_embeddings_colbert.csv", final_embeddings_colbert, delimiter=",")
print("colbert Done")

# Splade Embeddings
final_embeddings_splade = SPLADE_vectorizer.vectorize_data(df_S2ORC, 'text', 'id')
print(final_embeddings_splade.shape)
np.savetxt("data_processing/embeddings/s2orc_embeddings_splade.csv", final_embeddings_colbert, delimiter=",")
print("splade Done")
...
np.savetxt("data_processing/embeddings/s2orc_embeddings_deepseek_qwen_1.5b.csv", final_embeddings_colbert, delimiter=",")
print("deepseek Done")
