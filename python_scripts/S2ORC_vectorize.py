...
np.savetxt("text_embeddings/s2orc_embeddings_bert.csv", final_embeddings_bert, delimiter=",")

# colBert Embeddings
final_embeddings_colbert = Bert_vectorizer.vectorize_data(df_S2ORC, 'text', 'id')
print(final_embeddings_colbert.shape)
np.savetxt("text_embeddings/s2orc_embeddings_colbert.csv", final_embeddings_colbert, delimiter=",")
