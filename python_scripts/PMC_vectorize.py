...
np.savetxt("python_scripts/text_embeddings/PMC_open_access_embeddings_bert.csv", final_embeddings_bert, delimiter=",")
...
np.savetxt("python_scripts/text_embeddings/PMC_open_access_embeddings_colbert.csv", final_embeddings_colbert, delimiter=",")
...
np.savetxt("python_scripts/text_embeddings/PMC_open_access_embeddings_splade.csv", final_embeddings_colbert, delimiter=",")
...
np.savetxt("python_scripts/text_embeddings/PMC_open_access_embeddings_deepseek_qwen_1.5b.csv", final_embeddings_colbert, delimiter=",")
print("deepseek Done")
