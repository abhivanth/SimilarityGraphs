...
np.savetxt("text_embeddings/PMC_open_access_embeddings_bert.csv", final_embeddings_bert, delimiter=",")
...
np.savetxt("text_embeddings/PMC_open_access_embeddings_colbert.csv", final_embeddings_colbert, delimiter=",")
...
np.savetxt("text_embeddings/PMC_open_access_embeddings_splade.csv", final_embeddings_colbert, delimiter=",")
